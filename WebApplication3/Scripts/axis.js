...
const request = axios.create({//https://bird.ioliu.cn/v2/?url=http://gank.io/api/day/history
    baseURL: 'https://bird.ioliu.cn/v2/?url=http://www.dmoe.cc/random.php',
...
service.interceptors.response.use(
    response => {
        ...
        // 状态码是1的时候表示返回的数据是真正有效的，其他code不是有效的会做拦截。现在暂时不拦截把所有情况的数据都return
        return response.data;
        // switch (response.data.code) {
        //     case 1:
        //         // 最终的有效请求，业务逻辑需要处理的数据，暴露
        //         //  关于弹窗提示，在具体调用模块里面具体写提示信息，比如查询成功
        //         return response.data;
        //         break;
        //     case 3:
        //         //权限判断：无权限 
        //         let errors = {
        //             message: '您无操作的权限，请联系管理员分配权限'
        //         }
        //         errorLog(errors);
        ...
        //         errorLog({ message: response.data.msg });
        //         return Promise.reject(response.data)
